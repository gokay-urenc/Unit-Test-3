...
namespace ShoppingCart.Tests
{
    ...
    public class CartTests
    {
        ...
        [TestMethod]
        public void When_one_of_the_products_in_the_cart_is_added_total_number_of_the_products_must_increase_and_total_item_number_stay_the_same()
        {
            // Arrange
            int totalQuantity = _cartManager.TotalQuantity;
            int totalItemNumber = _cartManager.TotalItems;
            ...
            // Assert
            Assert.AreEqual(totalQuantity + 1, _cartManager.TotalQuantity);
            Assert.AreEqual(totalItemNumber, _cartManager.TotalItems);
        }
    }
}